...
![alt text](Med条件筛选汇总.png)

![alt text](Med自定义发生率.png)  

 若下拉选项选择采取措施组（对任一药物采取的措施、对单个药物采取的措施），会新增筛选框**选择关注的对药物采取的措施类型**。  
![alt text](Med采取措施组.png)
...
![alt text](Med术语选项.png)


在表格最上方下拉可以选择不同的表格类型。  
![alt text](Med表格选择.png)
...
![alt text](Med表格3展示.png)

![alt text](Med表格4展示.png)

![alt text](Med表格4额外.png)  